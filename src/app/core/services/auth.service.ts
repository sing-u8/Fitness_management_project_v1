...
export class AuthService {
  ...
  signInWithFirebase(
    requestBody: SignInWithFirebaseRequestBody
  ): Observable<User> {
  ...
  checkDuplicateMail(
    requestBody: CheckDuplicateMailRequestBody
  ): Observable<Response> {
  ...
  sendVerificationCodeMail(
    requestBody: SendVerificationCodeMailRequestBody
  ): Observable<Response> {
  ...
  checkVerificationCodeMail(
    requestBody: CheckVerificationCodeMailRequestBody
  ): Observable<Response> {
  ...
  sendResetPasswordLinkMail(
    requestBody: SendResetPasswordLinkMailRequestBody
  ): Observable<Response> {
  ...
  checkResetPasswordLinkMail(
    requestBody: CheckResetPasswordLinkMailRequestBody
  ): Observable<Response> {
  ...
  sendVerificationCodeMailChange(
    requestBody: SendVerificationCodeMailChangeRequestBody
  ): Observable<Response> {
  ...
  checkVerificationCodeMailChange(
    requestBody: CheckVerificationCodeMailChangeRequestBody
  ): Observable<Response> {
  ...
  sendVerificationCodeSMSChange(
    requestBody: SendVerificationCodeSMSChangeRequestBody
  ): Observable<Response> {
  ...
  checkVerificationCodeSMSChange(
    requestBody: CheckVerificationCodeSMSChangeRequestBody
  ): Observable<Response> {
