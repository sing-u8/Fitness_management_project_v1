...
import { RoleModal, Permission } from '@schemas/store/app/modal.interface'
...
export const showRoleModal = createAction(
    ...
    props<{ center: Center; permissionCategObj: Permission }>()
)
...
export const startCloseRoleModal = createAction(
    ...
    props<{ clickEmitter: ClickEmitterType; permissionCategObj: Permission; center: Center }>()
)
