...
@Component({
    selector: 'rw-modify-ticket-staff-select',
    templateUrl: './modify-ticket-staff-select.component.html',
    styleUrls: ['./modify-ticket-staff-select.component.scss'],
    providers: [
        {
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => ModifyTicketStaffSelectComponent),
            multi: true,
        },
    ],
})
export class ModifyTicketStaffSelectComponent implements AfterViewInit, ControlValueAccessor {
