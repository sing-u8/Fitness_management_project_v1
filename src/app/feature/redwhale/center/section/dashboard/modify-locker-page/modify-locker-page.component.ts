...
@Component({
    selector: 'db-modify-locker-page',
    templateUrl: './modify-locker-page.component.html',
    styleUrls: ['./modify-locker-page.component.scss'],
})
export class ModifyLockerPageComponent implements OnInit, OnDestroy {
