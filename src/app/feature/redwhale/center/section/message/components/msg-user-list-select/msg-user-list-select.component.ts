...
import { MemberSelectCateg } from '@centerStore/reducers/sec.sms.reducer'

@Component({
    selector: 'msg-user-list-select',
    templateUrl: './msg-user-list-select.component.html',
    styleUrls: ['./msg-user-list-select.component.scss'],
    providers: [
        {
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => MsgUserListSelectComponent),
            multi: true,
        },
    ],
})
export class MsgUserListSelectComponent implements AfterViewInit, ControlValueAccessor {
