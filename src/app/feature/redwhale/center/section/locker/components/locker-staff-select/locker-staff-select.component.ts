...
@Component({
    selector: 'rw-locker-staff-select',
    templateUrl: './locker-staff-select.component.html',
    styleUrls: ['./locker-staff-select.component.scss'],
    providers: [
        {
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => LockerStaffSelectComponent),
            multi: true,
        },
    ],
})
export class LockerStaffSelectComponent implements AfterViewInit, ControlValueAccessor {
