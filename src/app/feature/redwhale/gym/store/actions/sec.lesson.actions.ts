...
export const startAddLessonCateg = createAction(
    ...
    props<{ gymId: string; categName: string }>()
)
...
// current gym
export const setCurrentGym = createAction(`[${FeatureKey}] Set Current Gym`, props<{ currentGym: string }>())
